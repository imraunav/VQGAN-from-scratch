...
from nn import VQGAN, Discriminator
...
class TrainVQGAN:
    def __init__(self, args):
        self.vqgan = VQGAN(
            ...
            encoder_training_res=args.image_size,
        ).to(device=args.device)
        self.discriminator = Discriminator(args.image_size).to(device=args.device)
